...
3. RENAME `src/Properties/_launchSettings.json` to `launchSettings.json`. This ensures that your local dev environment launches with Development mode enabled.
